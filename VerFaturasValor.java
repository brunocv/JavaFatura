...
public class VerFaturasValor extends JFrame {
    ...
    public VerFaturasValor (Users d, Info u) {
        ...
        if (d.existeUser(u.getNIF())) {
            ...
            for(Fatura f : em.faturasPorValorDecrescente()) {
    ...
    public static void visualizar_valor(Users b, Info u) {
        VerFaturasValor gui = new VerFaturasValor(b,u);
