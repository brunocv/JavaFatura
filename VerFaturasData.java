...
public class VerFaturasData extends JFrame {
    ...
    public VerFaturasData (Users d, Info u) {
    ...
    public static void visualizar_data(Users b, Info u) {
        VerFaturasData gui = new VerFaturasData(b,u);
